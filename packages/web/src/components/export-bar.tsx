...
export function ExportModal({
  ...
  }, [resolution, withBg, aspect, aspectRatioValue, captureFn, onExportStart, onExportEnd]);
      ...
      <DialogContent className="max-w-2xl">
        ...
        <DialogFooter>
          <Button
            ...
            className="gap-1.5"
            disabled={externalIsExporting}
          >
            <Trash2 className="h-3.5 w-3.5" />
            Discard
          </Button>
          <Button onClick={handleImageDownload} disabled={externalIsExporting} className="gap-1.5">
            {externalIsExporting ? (
               <div className="h-3.5 w-3.5 border-2 border-current border-t-transparent rounded-full animate-spin" />
            ) : (
               <Download className="h-3.5 w-3.5" />
            )}
            Download PNG (2 Credits)
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
        ...
        <DialogFooter className="flex items-center justify-end sm:justify-end gap-2">
          ...
          >
            ...
            <span className="relative flex items-center gap-1.5">
              ...
              <span className="text-xs">Download {videoFormat.toUpperCase()} (2 Credits)</span>
            </span>
          </Button>
        </DialogFooter>
      </DialogContent>
