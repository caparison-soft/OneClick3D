...
export function InputPanel({
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.type.startsWith("image/") && file.type !== "image/svg+xml") {
      ...
      try {
        setUploadedSvgContent('<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><text x="10" y="50">Tracing image...</text></svg>');
        ...
        if (data.svg) {
          setUploadedSvgContent(data.svg);
          onFileSvgChange(data.svg);
        } else {
          setUploadedSvgContent('<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><text x="10" y="50">Error tracing</text></svg>');
        }
      } catch (err) {
        setUploadedSvgContent('<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><text x="10" y="50">Error tracing</text></svg>');
      }
